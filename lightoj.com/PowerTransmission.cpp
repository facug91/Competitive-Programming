/*
        By: facug91
        From: http://www.lightoj.com/volume_showproblem.php?problem=1155
...
int n, m, b, d, s, t, u, v, w, res[220][220], level[220];
vi adj[220];
...
int main () {
	...
	for (int it=1; it<=tc; it++) {
		...
		for (i=0; i<d; i++) {
			cin>>u;
			adj[u*2-1].push_back(t);
			adj[t].push_back(u*2-1);
			res[u*2-1][t] = INT_MAX;
		}
