/*
        By: facug91
        From: https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=627
...
int main () {
	...
	for (i=0; i<35000; i++) sieve[i] = true;
	sieve[0] = sieve[1] = false;
	for (i=4; i<35000; i+=2) sieve[i] = false;
	for (i=3; i<200; i++)
		if (sieve[i])
