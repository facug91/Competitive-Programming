/*
        By: facug91
        From: https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1403
...
int main () {
	...
	for (int it=1; it<=tc; it++) {
		...
		if (number_of_sets != 1) cout<<"No way"<<endl;
		else {
			ans = INT_MAX;
			...
			if (ans == INT_MAX) cout<<"No second way"<<endl;
			else cout<<ans<<endl;
		}
	}
